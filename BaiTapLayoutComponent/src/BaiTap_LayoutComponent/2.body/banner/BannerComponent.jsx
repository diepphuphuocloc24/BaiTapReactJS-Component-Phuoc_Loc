    ...
    return (
        <div>
            <div className="w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm text-left">
                ...
                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 hover:bg-red-700 transition-all duration-300">
                    Read more
